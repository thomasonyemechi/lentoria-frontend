    ...
    <div class="container">
        <div class="row mt-0 mt-md-4">
            <div class="col-12">
                ...
                <div class="card mb-4 overflow-hidden">
                    ...
                    <div class="row">
                        ...
                        <div class="ms-0 col-md-4"
                             style="background-image: url(../assets/images/about/16.jpg); background-size: cover; background-repeat: no-repeat; background-position: center; overflow: hidden; border-radius: 0.5rem;">
                        </div>
                    </div>
                </div>
                <div class="card mb-4 overflow-hidden">
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="ms-3"><h1 class="display-4 ms-2 fw-bold mb-0 ">Welcome to Livepetal’s </h1>
                                <h1 class="display-4 ms-2 fw-bold  mb-3">Affiliate Program Terms</h1></div>
                            <div class="row ms-2">
                                <div class="col-12 col-md-6 col-lg-6 col-sm-12 justify">
                                    ...
                                    <p><b><span style="color: green">2. </span></b>Keep in mind that these terms
                                        ...
                                        settings
                                        which also form part of our agreement with you (we’ll call these the Platform Terms). </p>

                                </div>
                                <div class="col-12 col-md-6 col-lg-6 col-sm-12">
                                    <p>The Livepetal platform also includes a
                        ...
                        <div class="d-none d-md-block col-md-4"
                             style="background-image: url(../assets/images/about/301.png); background-size: cover; background-position: center; background-repeat: no-repeat; overflow: hidden; border-radius:0.5rem;">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4 overflow-hidden">
                    <div class="row">
                        <div class="col-md-6 col-12 p-5 justify">
                        ...
                        <div class="col-md-6 d-none d-md-block p-5"
                             style="background-image: url(../assets/images/about/07.png); background-size: cover; background-position: center; background-repeat: no-repeat; overflow: hidden; border-radius:0.4rem;">
                        </div>
                    ...
                    <div class="row ms-2">
                        ...
                        <div class="col-lg-4 col-sm-12 col-md-4">
                            ...
                            <p><b><span style="color: green">20. </span></b>Tax. You are responsible for paying all
                                ...
                                your
                                use of the Affiliate Program wherever levied. We collect geographical location
                            ...
                            <div class="row ms-2">
                                <div class="col-lg-4 col-sm-12 col-md-4">
                                    ...
                                    <p><b><span style="color: green">22 </span></b>Your compliance: we reserve the
                                        right
                                        to decide in our sole discretion whether your use of the Affiliate
                                ...
                                <div class="col-lg-4 col-sm-12 col-md-4">
                                    ...
                                    <p><b><span style="color: green">25 </span></b>Termination by us: we may
                                        ...
                                        we
                                        might do this includes transactions where the payment is from or to a person
                                        or
                    ...
                    <div class="row">
                        ...
                        <div class="ms-0 col-md-8">
                            <img src="{{asset('assets/images/about/12.jpg')}}" alt=""
                                 class="img-fluid rounded-1 d-md-block"/>
                        </div>
                    </div>
                </div>
