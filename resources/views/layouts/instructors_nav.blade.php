...
<a href="notification-history.html" class="text-link fw-semi-bold">See all Notifications</a>
</div>
</div>
</div>
</li>
...
<li>
<a href="landings/request-access.html" class="dropdown-item">
    Request Access<span class="badge bg-warning ms-1">New</span>
</a>
</li>
...
<li>
<a class="dropdown-item" href="{{ route('instructor.add-course') }}">
    Add New Course
</a>
</li>
<li class="dropdown-submenu dropend">
...
<div class="border-top px-3 pt-3 pb-0">
<a href="notification-history.html" class="text-link fw-semi-bold">See all
    Notifications</a>
</div>
</div>
</div>
