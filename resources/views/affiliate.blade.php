...
@section('page_title', 'Become Affliate')
        ...
        <div class="container">
            <div class="row mb-10 justify-content-center">
                <div class="col-lg-8 col-md-12 col-12 text-center">
                    <!-- caption -->
                    <span class="text-primary mb-3 d-block text-uppercase fw-semi-bold ls-xl">Learn how how to sell
                        anything online</span>
                    <h2 class="mb-2 display-4 fw-bold ">Become a professional top-ranking Affiliate</h2>
                    <p class="lead">The Lentoria Affiliate Programme introduces you to a complete sales automation process
                        that will teach you how to set up a system that automatically generates massive sales for you and
                ...
                <div class="col-lg-3 col-md-6 col-12 text-center">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="fs-4">Our tools provide all the guide you need to create multiple simulteneous
                ...
                <div class="col-lg-3 col-md-6 col-12 text-center">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="fs-4">You will be trained with practical tools by industry experts to sell any type
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="fs-4">Lentoria acelerated marketing and sales program will help you generate all the
                                sales you need to cashout regularly</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-7 offset-right-md-6 col-12 mb-6">
                    ...
                    <p class="lead text-white">The answer is simple! To create online systems that guarantees multiple
                        independent streams of quality income. You most likely want to create machine-like systems that can
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="card mb-4 mb-lg-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0"><big>Understanding how to engage your sales skills will put you in control and
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="card mb-4 mb-lg-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0"><big>The mentorship Lentoria provides will take you from a complete novice to
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12 col-12 text-center">
                    ...
                    <p class="lead">You can kick start your journey towards becoming an expert affiliate with just simple
    ...
    <div class="pt-lg-12 pb-lg-3 pb-6 pt-0">
        ...
        <div class="row bg-primary">
            <div class="col-lg-6 text-center m-0 p-8">
                ...
                <h2 class="lead text-white">The Lentoria affilliate programme gives you the freedom to structure the way you
                    want to work and decide how quick you want to achieve your financial goals. This is a sure pathway to
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <h1>3</h2>
                        <div class="border-top pt-4 mt-0 mb-5">
                            <h3 class="mb-2">Take the Affilliate Success Challenge</h3>
                ...
                <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-12">
                    <div class="text-center mb-6 px-md-6">
                        ...
                        <p class="text-white lead mb-8">
                            Membership plans that guarantees your consistent earning as an affiliate. Membership fees are
                        ...
                        <div class="p-5 text-center">
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                ...
                                <div class="price-card--price-number toggle-price-content odometer"
                                    data-price-monthly="39" data-price-yearly="99">15,000</div>
                            </div>
                            <div class="d-grid">
                    ...
                    <div class="card  border border-primary mb-3 mb-lg-0">
                        ...
                        <div class="p-5 text-center">
                            <div class="mb-5">
                                ...
                                <p class="mb-0 "><span class="text-dark fw-medium">Access to special features </span> and
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                <span class="h3 mb-0 fw-bold">N</span>
                                <div class="price-card--price-number toggle-price-content odometer"
                                    data-price-monthly="99" data-price-yearly="199">40,000</div>
