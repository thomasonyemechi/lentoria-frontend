@extends('layouts.virtual_class')

@section('page_title', 'Course | Virtual Class')
                                ...
                                <li class="user-list-item">
                                    ...
                                    <div class="users-list-body">
                                        <div>
                                            ...
                                            <p><span class="material-icons">videocam</span> It seems logical that
                                                the</p>
                                        </div>
                                        <div class="last-chat-time">
                                            <small class="text-muted">Yesterday</small>
                ...
                <div class="right-sidebar-wrap active">
                    <div class="slimscroll">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs justify-content-center" id="nav-tab">
                                                <a class="nav-item nav-link active" id="nav-home-tab"
                                                    data-bs-toggle="tab" href="#about">About</a>
                        ...
                        <div class="report-col">
                            <ul>
                                <li><a href="#"><span class="material-icons">report_problem</span> Report Chat</a>
                                </li>
