														...
														<div class="card-body py-6">
															<div class="mt-4">
																...
																<p class="text-white-50 fs-6">
																	Designed to replicate the experience and benefit of attending a face-to-face training course
																</p>
																<a href="javascript:void(0)" class="btn btn-white btn-sm mt-2 seltype" data-type="1">Select</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card bg-dark-primary shadow-none text-center mx-4 my-8">
														<div class="card-body py-6">
															<div class="mt-4">
																...
																<p class="text-white-50 fs-6">
																	Add Course Materials For Students To Learn At Their Own Pace
																</p>
																<a href="javascript:void(0)" class="btn btn-white btn-sm mt-2 seltype" data-type="2">Select</a>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card bg-dark-primary shadow-none text-center mx-4 my-8">
														<div class="card-body py-6">
															<div class="mt-4">
																...
																<a href="javascript:void(0)" class="btn btn-white btn-sm mt-2 seltype" data-type="3">Select</a>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="card mb-3  border-0">
										...
										<div class="card-body ">
											...
											<div class="mb-3">
												...
												<input class="form-control" type="text" placeholder="Course Subtitle" id="courseSubtitle" />
											</div>
