            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="row text-start g-3" id="addVideoForm" enctype="multipart/form-data">
                        <input type="hidden" name="lecture_id" />
                        <input type="hidden" name="section_id" />
                        <input type="hidden" id="lecture_title" />
                        <input type="hidden" id="lecture_description" />
                        <div class="col-md-12">
                            <label for="" class="text-bold fw-semi-bold text-dark">Select Video</label>
                            <input name="video" type="file" id="file_pond" />
                        </div>
                    ...
                    res.data.map(lec => {
                        ...
                        <div class="list-group-item rounded px-3 mb-1" id="${stripLower(lec.title+lec.id)}">
                            ...
                            <div id="collapselist${lec.id}" class="collapse" aria-labelledby="${stripLower(lec.title+lec.id)}"
                                ...
                                <div class="card-body">
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addVideoModal" class="btn btn-secondary btn-sm">Add
                                    Video +</a>
