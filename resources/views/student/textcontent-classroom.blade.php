            ...
            function showLecture(lecture) {
                ...
                const unlockedTemplate = `
                    <li class="list-group-item">
                      <a href="#" data-vid="${lecture.main_content}" class="d-flex justify-content-between align-items-center text-inherit text-decoration-none vidwatch">
                        <div class="text-truncate">
                ...
                return lecture.is_locked ? lockedTemplate : unlockedTemplate;
            }
